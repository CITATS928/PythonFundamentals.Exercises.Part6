...
def temperature_tuple(temperatures: Iterable, input_unit_of_measurement: str) -> Tuple[Tuple[float, float]]:
    ...
    Each tuple contains two values. The first is the value of the temperatures parameter. The second is the the value of the first converted to the unit of measurement specified in the input_unit_of_measurement parameter.
    ...
    if(input_unit_of_measurement=='c'):
        for value in temperatures:
            tup+=((float(value),convert_to_fahrenheit(value)),)
    if(input_unit_of_measurement=='f'):
        for value in temperatures:
            tup+=((float(value),convert_to_celsius(value)),)
